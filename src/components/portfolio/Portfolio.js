        ...
        <section id={"portfolio"}>
            ...
            <div className={"container portfolio__container"}>
                <article className={"portfolio__item"}>
                    ...
                    <div className={"portfolio__item-copy"}>
                        <h3 className={"card__title"}>The Ride That Keeps Me Balanced</h3>
                        <p>
                ...
                <article className={"portfolio__item"}>
                    ...
                    <div className={"portfolio__item-copy"}>
                        <h3 className={"card__title"}>How I See the Wild </h3>
                        <p>
                ...
                <article className={"portfolio__item"}>
                    ...
                    <div className={"portfolio__item-copy"}>
                        <h3 className={"card__title"}>Brew Experiments</h3>
                        <p>
                ...
                <article className={"portfolio__item"}>
                    ...
                    <div className={"portfolio__item-copy"}>
                        <h3 className={"card__title"}>Strong Body, Stronger Mind</h3>
                        <p>
